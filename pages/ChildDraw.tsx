...
const ChildDraw: React.FC = () => {
  const drawType = 'child_2025';
  const {
    numbers,
    addNumber,
    removeNumber,
  ...
  return (
    <div className="flex flex-col w-full max-w-[1200px] mx-auto px-4 md:px-10 py-8">
      <div className="flex flex-col gap-2 mb-8 text-center md:text-left">
        <h1 className="text-4xl font-black tracking-tight text-[#111813]">Lotería del Niño</h1>
